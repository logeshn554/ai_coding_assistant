@echo off
title Loopix AI Editor - Exe Builder
echo =========================================================
echo       Building Loopix AI Editor Windows Executable
echo =========================================================
echo.
...
echo  Executable Location: dist\Loopix\Loopix.exe
echo  Desktop Shortcut Created: "Loopix AI Editor"
echo =========================================================
pause
