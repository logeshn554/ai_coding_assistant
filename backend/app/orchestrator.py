...
planner_prompt_template = PromptTemplate.from_template(
    "You are the Planner Agent. Decompose this request into an ordered, dependency-aware subtask plan.\n\n"
    "Request: {task_description}\n\n"
    "Rules:\n"
    "- Every subtask must have an 'agent', 'description', and 'dependencies' (list of IDs that must finish first).\n"
    "- Tasks with empty dependencies[] can run in parallel immediately.\n"
    "- Group tasks that should run concurrently at the same dependency level.\n"
    "- Include exactly ONE of: Coding Agent, Frontend Developer Agent, or Backend Developer Agent "
    "(choose based on the nature of changes — never all three on the same files).\n"
    "- ALWAYS include a Terminal Agent step after code changes to verify compilation.\n"
    "- ALWAYS include a Testing Agent step after the Terminal Agent step.\n\n"
    ...
    '  {{"id": 4, "agent": "Terminal Agent", "description": "...", "dependencies": [3]}},\n'
    '  {{"id": 5, "agent": "Testing Agent", "description": "...", "dependencies": [4]}},\n'
    '  {{"id": 6, "agent": "Documentation Agent", "description": "...", "dependencies": [3]}},\n'
    '  {{"id": 7, "agent": "Git Agent", "description": "...", "dependencies": [5, 6]}}\n'
    "]\n\n"
...
coding_prompt_template = PromptTemplate.from_template(
    ...
    "- Output ONLY the complete, updated raw file content. No markdown code blocks or fences. No preamble.\n"
    "- Never truncate with placeholders like '# ... rest of code' or '# TODO'. Output the complete file.\n"
    "- Add a one-line header comment at the top: # Generated by Coding Agent — {task_description}\n"
    "- If the file exceeds 500 lines, split into logical modules and list the file names."
)
...
debugging_prompt_template = PromptTemplate.from_template(
    "You are the Debugging Agent. Analyze the log below and produce concrete, actionable fixes.\n\n"
    "Log:\n{history_summary}\n\n"
    "Output format (strict markdown):\n\n"
    "## Root Cause\n"
    "One sentence stating the exact error and its mechanism.\n\n"
    "## Fix\n"
    "Show ONLY the changed lines (file path + diff). If multiple files, label each.\n\n"
    "## Why it failed\n"
    "Explain the underlying mechanism in 2-3 sentences.\n\n"
    "## Prevention\n"
    "One concrete change (test, lint rule, type check, env guard) to prevent recurrence.\n\n"
    "If no errors are found in the logs, output exactly: `No issues identified.`"
)
...
orchestrator_prompt_template = PromptTemplate.from_template(
    ...
    "9. RULE: Never call any of [Coding Agent, Frontend Developer Agent, Backend Developer Agent] "
    "unless shared_memory['file_contents'] is non-empty.\n\n"
...
frontend_dev_prompt_template = PromptTemplate.from_template(
    ...
    "- Output ONLY the complete, updated raw file content. No markdown code blocks or fences. No preamble.\n"
    "- Never truncate with placeholders like '// ... rest of code' or '// TODO'. Output the complete file.\n"
    "- Add a one-line header comment at the top: // Generated by Frontend Developer Agent — {task_description}\n"
    "- If the file exceeds 500 lines, split into logical modules and list the file names."
)
...
backend_dev_prompt_template = PromptTemplate.from_template(
    ...
    "- Output ONLY the complete, updated raw file content. No markdown code blocks or fences. No preamble.\n"
    "- Never truncate with placeholders like '# ... rest of code' or '# TODO'. Output the complete file.\n"
    "- Add a one-line header comment at the top: # Generated by Backend Developer Agent — {task_description}\n"
    "- If the file exceeds 500 lines, split into logical modules and list the file names."
)
